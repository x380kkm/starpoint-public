# audience: external
# # setup-emulator
# 此脚本安装固定版本的 Android SDK 工具和带 ARM64 native bridge 的 API 35 Google APIs x86_64 镜像, 再创建 64 GB 数据盘的专用 AVD, 供完整 APK 安装、内嵌游戏安装和 CDN 解包使用.
...
$DataPartitionSize = "64G"
if ([string]::IsNullOrWhiteSpace($AvdName)) {
    $AvdName = "starpoint-cn-api35-x86_64-64g"
}
