...
param(
    [string]$SdkRoot,
    [string]$AvdHome,
    [string]$AvdName = "starpoint-cn-api35-x86_64",
...
$ExistingDevice = Invoke-ProtocolLabAdb -AdbPath $AdbPath -Serial $Serial -CommandArguments @("get-state") -AdbServerPort $ResolvedAdbServerPort -AllowFailure -TimeoutSeconds $AdbCommandTimeoutSeconds
if ($ExistingDevice.ExitCode -eq 0) {
